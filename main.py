...
def main(cloud_event):
    ...
    try:
        ...
        # LOG THE ERROR (So you can see it in Cloud Logging)
        logger.error(f"❌ CRITICAL FAILURE: {str(e)}", exc_info=True)
        
        # STOP THE RETRY LOOP
        # By returning 200 (OK), we tell Pub/Sub "I handled it, stop calling me."
        return "Script Failed (Stopping Retries)", 200
